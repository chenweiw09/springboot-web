package com.xiaomi.chen.springboottest.servletwrapper;
...
public class MyHttpServletResponseWrapper extends HttpServletResponseWrapper {
    ...
    public PrintWriter getWriter() throws IOException {
        return new PrintWriter(myServletOutputStream.baos);
    }
    ...
    public String getContent() {
        try {
            ...
            return myServletOutputStream.baos.toString(responseEncoding != null ? responseEncoding : UTF_8.name());
    ...
    public byte[] getContentAsBytes() {
        return myServletOutputStream.baos.toByteArray();
    }
